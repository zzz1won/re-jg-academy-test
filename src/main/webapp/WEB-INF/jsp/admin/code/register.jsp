    ...
    $(function(){
        ...
        $('#btn_confirm_register').click(function(){
            ...
            if(check){
                ...
                $.ajax({
                    type: "post",
                    url: "<c:out value='${pageContext.request.contextPath}/code/admin/register'/>",
                ...
                <div class="table-write-wrap">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="groupCodeName" name="groupCodeName" class="input-text" style="width: 100%;" placeholder="groupCodeName">
                            </td>
                            <th class="required_need">그룹코드값</th>
                            <td>
                                <input type="text" id="groupCode" name="groupCode" class="input-text" style="width: 100%;" placeholder="groupCode">
                            </td>
                        </tr>
                        <tr>
                            <th class="required_need">코드명</th>
                            <td>
                                <input type="text" id="codeName" name="codeName" class="input-text" style="width: 100%;" placeholder="codeName">
                            </td>
                            <th class="required_need">코드값</th>
                            <td>
                                <input type="text" id="code" name="code" class="input-text" style="width: 100%;" placeholder="code">
                            </td>
                        </tr>
                        <tr>
                            <th class="required_need">순서</th>
                            <td colspan="3">
                                <input type="text" id="displayOrder" name="displayOrder" class="input-text" style="width: 100%;" placeholder="순서">
                            </td>
                        </tr>
                        <tr>
                            <th>비고</th>
...
<div class="modal no_close" id="pop_confirm_register">
    <div class="popup-content">
        <p class="pop-text">해당 코드를 등록 하시겠습니까?</p>
        <div class="btn-wrap">
...
<script type="text/javascript">
    ...
    nhn.husky.EZCreator.createInIFrame({
        oAppRef: oEditors,
        elPlaceHolder: "acEduContents", //얘를 codeContents로 바꾸면 안되나?
